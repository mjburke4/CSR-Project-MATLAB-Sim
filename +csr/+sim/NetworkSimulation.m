classdef NetworkSimulation < handle
    ...
    methods
        function obj = NetworkSimulation(config)
            ...
            for k = 1:n
                ...
                hopCallbacks = struct('EnqueueMac',@(frame)obj.enqueueMac(nodeId,frame), ...
                    ...
                    'NsdpRelease',@(app,reason)obj.Networks{k}.release(app,reason), ...
        ...
        function result = run(obj)
            ...
            metadata.SecurityProfile = 'behavioral-admission; no cryptographic key protection';
    ...
    methods (Access = private)
        ...
        function receive(obj,frame,nodeId,decision)
            ...
            index = obj.NodeIndex(nodeId);
            % Every decoded outer refreshes the heard peer, including feedback
            % and frames addressed elsewhere. Member addressing stays in HOP.
            obj.Networks{index}.observe(frame.SourceId,decision);
